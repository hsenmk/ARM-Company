        ...
        <div className="mx-auto max-w-7xl px-6">
          ...
          <div className="grid gap-8 sm:gap-10 md:grid-cols-2 md:items-center md:gap-12">            <div>
            ...
            <p className="mt-7 max-w-xl leading-7 text-gray-400">
              Come visit ARM Company and discover our brands in person.
            </p>
            ...
            <a
              ...
              className="inline-flex items-center justify-center rounded-lg bg-white px-6 py-3 text-sm font-semibold !text-black transition hover:bg-gray-200"
            >
              Get Directions
            </a>
        ...
        <div className="mx-auto max-w-7xl px-6">
          ...
          <div className="grid gap-12 md:grid-cols-2 md:gap-16">
            ...
            <div>
              ...
              <p className="mt-7 max-w-xl leading-7 text-gray-400">
                Have a question about our brands or want to learn
            ...
            <div>
              ...
              >
                ...
                {formStatus && formStatus !== "Sending..." && (
                  <p
                    className={`text-center text-sm ${formStatus.includes("successfully")
                        ? "text-green-400"
                        : "text-red-400"
                      }`}
                  >
          ...
          <div className="grid gap-10 md:grid-cols-3">
            ...
            <div>
              ...
              <div className="mt-5 space-y-4">
                ...
                {/* WeChat */}
                <a
                  href="https://u.wechat.com/kCIUJETcn8mzMWeQR2lBppE?s=3"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-3 text-sm text-gray-400 transition hover:text-white"
                >
